...
describe 'hello', ->
  ...
  describe 'listeners[0].regex', ->
    describe 'valid patterns', ->
      beforeEach ->
        @tests = [
          message: '@hubot github-public-repos bouzuya'
          matches: ['@hubot github-public-repos bouzuya', 'bouzuya', undefined]
        ,
          message: '@hubot github public repos bouzuya'
          matches: ['@hubot github public repos bouzuya', 'bouzuya', undefined]
        ,
          message: '@hubot github public repos bouzuya count'
          matches: [
            '@hubot github public repos bouzuya count'
            'bouzuya'
            ' count'
          ]
        ]
  ...
  describe 'robot.helpCommands()', ->
    it 'should be ["hubot github-public-repos - ' +
